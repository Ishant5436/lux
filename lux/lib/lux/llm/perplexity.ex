defmodule Lux.LLM.Perplexity do
  @moduledoc """
  Perplexity LLM implementation that supports passing Beams, Prisms, and Lenses as tools.
  """
  ...
  defmodule Config do
    @moduledoc """
    Configuration module for Perplexity.
    """
    @type t :: %__MODULE__{
            endpoint: String.t(),
            model: String.t(),
  ...
  def parse_content(content) when is_binary(content) and content != "" do
